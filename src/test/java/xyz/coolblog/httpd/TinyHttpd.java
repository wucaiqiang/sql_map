...
public class TinyHttpd {
    ...
    private void handleOK(SocketChannel channel, String path) throws IOException {
        ...
        ByteBuffer bodyBuffer = readFile("");
    ...
    private ByteBuffer readFile(String html) throws IOException {
        String path = TinyHttpd.class.getResource("/").getPath() + (StringUtils.isBlank(html)?INDEX_PAGE:html);
